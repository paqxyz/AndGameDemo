...
import cn.ollyice.library.rxjava.internal.util.NotificationLite;
 ...
 * <p>
 * Since a {@code ReplaySubject} is an {@link cn.ollyice.library.rxjava.Observable}, it does not support backpressure.
 * <p>
 * When this {@code ReplaySubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link cn.ollyice.library.rxjava.Observer}s will receive the retained/cached items first (if any) followed by the respective
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code ReplaySubject} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
