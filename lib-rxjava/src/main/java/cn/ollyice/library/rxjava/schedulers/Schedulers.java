...
import cn.ollyice.library.rxjava.Scheduler;
import cn.ollyice.library.rxjava.annotations.NonNull;
import cn.ollyice.library.rxjava.internal.schedulers.*;
...
public final class Schedulers {
     ...
     * <p>
     * This type of scheduler is less sensitive to leaking {@link cn.ollyice.library.rxjava.Scheduler.Worker} instances, although
     ...
     * {@link RxJavaPlugins#setInitComputationSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} plugin method.
     ...
     * via the {@link RxJavaPlugins#setComputationSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} method.
     * <p>
     ...
     * &#64;{@link cn.ollyice.library.rxjava.annotations.SchedulerSupport SchedulerSupport}({@link cn.ollyice.library.rxjava.annotations.SchedulerSupport#COMPUTATION COMPUTATION})
     * annotation.
     ...
     * returned by {@link cn.ollyice.library.rxjava.Scheduler#createWorker()} but otherwise will start a new backing
     ...
     * or when implementing an operator, the Worker instances must be disposed via {@link cn.ollyice.library.rxjava.Scheduler.Worker#dispose()}.
     * <p>
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitIoSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setIoSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link cn.ollyice.library.rxjava.annotations.SchedulerSupport SchedulerSupport}({@link cn.ollyice.library.rxjava.annotations.SchedulerSupport#IO IO})
     * annotation.
    ...
    /**
     * Returns a default, shared {@link Scheduler} instance whose {@link cn.ollyice.library.rxjava.Scheduler.Worker}
     ...
     * the Worker instances must be disposed via {@link cn.ollyice.library.rxjava.Scheduler.Worker#dispose()}.
     * <p>
     * Unhandled errors will be delivered to the scheduler Thread's {@link java.lang.Thread.UncaughtExceptionHandler}.
     * <p>
     * You can control certain properties of this standard scheduler via system properties that have to be set
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitNewThreadSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setNewThreadSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link cn.ollyice.library.rxjava.annotations.SchedulerSupport SchedulerSupport}({@link cn.ollyice.library.rxjava.annotations.SchedulerSupport#NEW_THREAD NEW_TRHEAD})
     * annotation.
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitSingleSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setSingleSchedulerHandler(cn.ollyice.library.rxjava.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link cn.ollyice.library.rxjava.annotations.SchedulerSupport SchedulerSupport}({@link cn.ollyice.library.rxjava.annotations.SchedulerSupport#SINGLE SINGLE})
     * annotation.
     ...
     * {@link cn.ollyice.library.rxjava.disposables.Disposable#dispose()}. In addition, tasks scheduled with
     * a time delay or periodically will use the {@link #single()} scheduler for the timed waiting
     * before posting the actual task to the given executor.
     * <p>
