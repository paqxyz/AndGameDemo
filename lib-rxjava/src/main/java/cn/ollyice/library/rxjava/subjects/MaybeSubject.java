 ...
 * <p>
 * Since a {@code MaybeSubject} is a {@link cn.ollyice.library.rxjava.Maybe}, calling {@code onSuccess}, {@code onError}
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code MaybeSubject} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
 ...
 *  {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code MaybeObserver}s
 *  cancel at once).
