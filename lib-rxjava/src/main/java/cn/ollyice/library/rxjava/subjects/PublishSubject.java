 ...
 * <p>
 * Since a {@code PublishSubject} is an {@link cn.ollyice.library.rxjava.Observable}, it does not support backpressure.
 * <p>
 * When this {@code PublishSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link cn.ollyice.library.rxjava.Observer}s only receive the respective terminal event.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code PublishSubject} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
