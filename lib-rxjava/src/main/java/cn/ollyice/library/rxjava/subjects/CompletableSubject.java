 ...
 * the {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} global error handler.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code CompletableSubject} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
 ...
 *  {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code CompletableObserver}s
 *  cancel at once).
