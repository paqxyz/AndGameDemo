 ...
 * {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} handler or the current thread's
 ...
 * from {@code onError} and {@code onComplete} into the global error handler via {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)}.
