...
import cn.ollyice.library.rxjava.annotations.CheckReturnValue;
...
import cn.ollyice.library.rxjava.internal.util.AppendOnlyLinkedArrayList.NonThrowingPredicate;
 ...
 * <p>
 * Since a {@code BehaviorSubject} is an {@link cn.ollyice.library.rxjava.Observable}, it does not support backpressure.
 * <p>
 * When this {@code BehaviorSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()}, the
 * last observed item (if any) is cleared and late {@link cn.ollyice.library.rxjava.Observer}s only receive
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code BehaviorSubject} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
 ...
 *  {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code Observer}s
 *  cancel at once).
