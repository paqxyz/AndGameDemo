...
import cn.ollyice.library.rxjava.internal.util.ExceptionHelper;
import cn.ollyice.library.rxjava.plugins.RxJavaPlugins;
import cn.ollyice.library.rxjava.schedulers.SchedulerRunnableIntrospection;
 ...
 * the static methods of the {@link cn.ollyice.library.rxjava.schedulers.Schedulers} utility class.
 * <p>
 ...
 * <p>
 * Implementations of the {@link #scheduleDirect} and {@link Worker#schedule} methods are encouraged to call the {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onSchedule(Runnable)}
 ...
 * wrap the incoming {@code Runnable} into a class that implements the {@link cn.ollyice.library.rxjava.schedulers.SchedulerRunnableIntrospection}
 ...
 * should return the {@link cn.ollyice.library.rxjava.disposables.Disposables#disposed()} singleton instance indicating the shut down/disposed
...
public abstract class Scheduler {
     ...
     * {@link Flowable#zip(cn.ollyice.library.reactivestreams.Publisher, cn.ollyice.library.reactivestreams.Publisher, cn.ollyice.library.rxjava.functions.BiFunction)} where
     ...
     * should return the {@link cn.ollyice.library.rxjava.disposables.Disposables#disposed()} singleton instance indicating the disposed
