 ...
 * <p>
 * Since a {@code SingleSubject} is a {@link cn.ollyice.library.rxjava.Single}, calling {@code onSuccess} or {@code onError}
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code SingleSubject} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
 ...
 *  {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code SingleObserver}s
 *  cancel at once).
