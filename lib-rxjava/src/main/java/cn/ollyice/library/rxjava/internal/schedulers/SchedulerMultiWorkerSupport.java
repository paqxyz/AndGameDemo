 ...
 * {@link cn.ollyice.library.rxjava.Scheduler} in a way that when asking for
 * at most the parallelism level of the Scheduler, those
 * {@link cn.ollyice.library.rxjava.Scheduler.Worker} instances will be running
...
public interface SchedulerMultiWorkerSupport {
    ...
    /**
     * Creates the given number of {@link cn.ollyice.library.rxjava.Scheduler.Worker} instances
