...
package cn.ollyice.library.rxjava.processors;
...
import cn.ollyice.library.rxjava.exceptions.MissingBackpressureException;
 ...
 * last observed item (if any) is cleared and late {@link cn.ollyice.library.reactivestreams.Subscriber}s only receive
 ...
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code BehaviorProcessor} does not operate by default on a particular {@link cn.ollyice.library.rxjava.Scheduler} and
 ...
 *  {@link cn.ollyice.library.rxjava.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code Subscriber}s
 *  cancel at once).
