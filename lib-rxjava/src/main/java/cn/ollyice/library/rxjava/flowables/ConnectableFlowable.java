...
package cn.ollyice.library.rxjava.flowables;
...
import cn.ollyice.library.rxjava.functions.Consumer;
import cn.ollyice.library.rxjava.internal.functions.*;
import cn.ollyice.library.rxjava.internal.operators.flowable.*;
import cn.ollyice.library.rxjava.internal.util.ConnectConsumer;
...
public abstract class ConnectableFlowable<T> extends Flowable<T> {
     ...
     * {@link Flowable} to its {@link Subscriber}s.
     * <p>
     * To disconnect from a synchronous source, use the {@link #connect(cn.ollyice.library.rxjava.functions.Consumer)} method.
     *
