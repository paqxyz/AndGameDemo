...
package cn.ollyice.library.rxjava.annotations;
...
public @interface SchedulerSupport {
     ...
     */
    String NEW_THREAD = "cn.ollyice.library.rxjava:new-thread";
    /**
     * The operator/class runs on RxJava's {@linkplain Schedulers#trampoline() trampoline scheduler}
     * or takes timing information from it.
     */
    String TRAMPOLINE = "cn.ollyice.library.rxjava:trampoline";
    /**
     ...
     */
    @Experimental
    String SINGLE = "cn.ollyice.library.rxjava:single";
