 ...
 */
package cn.ollyice.library.okio;
...
import static cn.ollyice.library.okio.Util.checkOffsetAndCount;
import static cn.ollyice.library.okio.Util.reverseBytesLong;
...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
   ...
   * its own invariants. Instead, it assumes a careful user who has studied cn.ollyice.library.okio's implementation
   ...
   * this is also the most efficient way to use buffers because it allows cn.ollyice.library.okio to employ several
   ...
   * </ul>
   *
   * <p>These optimizations all leverage the way cn.ollyice.library.okio stores data internally. cn.ollyice.library.okio Buffers are
   ...
   * saves the JVM from needing to zero-fill byte arrays. cn.ollyice.library.okio doesn't need to zero-fill its arrays
   ...
   * segment sizes will change with advances in hardware. Future versions of cn.ollyice.library.okio may even have
