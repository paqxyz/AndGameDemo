 ...
 * {@link cn.ollyice.library.okio#buffer(Sink)} to wrap any sink with a buffer.
 *
 ...
 * Use {@link cn.ollyice.library.okio#sink} to adapt an {@code OutputStream} to a sink. Use {@link
