...
final class FieldResourceBinding implements ResourceBinding {
  enum Type {
    ...
    BOOL("getBoolean"),
    COLOR(new ResourceMethod(null, "getColor", false, 1),
        new ResourceMethod(null, "getColor", false, 23)),
    COLOR_STATE_LIST(new ResourceMethod(null, "getColorStateList", false, 1),
  ...
  @Override public CodeBlock render(int sdk) {
    ...
    return CodeBlock.of("target.$L = context.getResources().$L((int)Utils.id(context,\"$L\"))", name, method.name, id.code);
  }
}
