...
import static cn.ollyice.library.butterknife.compiler.BindingSet.ANIMATION_UTILS;
...
final class FieldAnimationBinding implements ResourceBinding {
  ...
  @Override public CodeBlock render(int sdk) {
    return CodeBlock.of("target.$L = $T.loadAnimation(context, (int)Utils.id(context,\"$L\"))", name, ANIMATION_UTILS,
            id.code);
  }
}
