...
import cn.ollyice.library.v4.util.ArrayMap;
import cn.ollyice.library.v4.util.LongSparseArray;
import cn.ollyice.library.v4.util.Pools;

import static cn.ollyice.library.widget.RecyclerView.ViewHolder;
import static cn.ollyice.library.widget.RecyclerView.ItemAnimator.ItemHolderInfo;

import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;
import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_APPEAR;
import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_PRE;
import static cn.ollyice.library.widget.ViewInfoStore.InfoRecord.FLAG_POST;
/**
...
class ViewInfoStore {
    ...
    interface ProcessCallback {
        ...
        void processAppeared(ViewHolder viewHolder,  ItemHolderInfo preInfo,
                ItemHolderInfo postInfo);
        void processPersistent(ViewHolder viewHolder,  ItemHolderInfo preInfo,
                 ItemHolderInfo postInfo);
