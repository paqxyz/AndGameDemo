...
import cn.ollyice.library.widget.RecyclerView.LayoutManager;
import cn.ollyice.library.widget.RecyclerView.SmoothScroller.ScrollVectorProvider;
...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
     ...
     */
    private boolean snapFromFling( LayoutManager layoutManager, int velocityX,
            int velocityY) {
    ...
    public abstract int[] calculateDistanceToFinalSnap( LayoutManager layoutManager,
             View targetView);
