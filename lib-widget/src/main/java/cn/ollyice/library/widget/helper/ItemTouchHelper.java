...
package cn.ollyice.library.widget.helper;

import android.content.res.Resources;
import android.graphics.Canvas;
import android.graphics.Rect;
import android.os.Build;
import cn.ollyice.library.v4.animation.AnimatorCompatHelper;
import cn.ollyice.library.v4.animation.AnimatorListenerCompat;
import cn.ollyice.library.v4.animation.AnimatorUpdateListenerCompat;
import cn.ollyice.library.v4.animation.ValueAnimatorCompat;
import cn.ollyice.library.v4.view.GestureDetectorCompat;
...
import cn.ollyice.library.widget.LinearLayoutManager;
import cn.ollyice.library.widget.RecyclerView;
import cn.ollyice.library.widget.RecyclerView.OnItemTouchListener;
import cn.ollyice.library.widget.RecyclerView.ViewHolder;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public void attachToRecyclerView( RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = dp(120);
            mMaxSwipeVelocity = dp(800);
            setupCallbacks();
        }
    }
    ...
    private static int dp(float dpValue){
