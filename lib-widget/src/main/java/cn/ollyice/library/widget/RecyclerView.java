...
import cn.ollyice.library.v4.os.ParcelableCompat;
import cn.ollyice.library.v4.os.ParcelableCompatCreatorCallbacks;
import cn.ollyice.library.v4.os.TraceCompat;
import cn.ollyice.library.v4.view.AbsSavedState;
import cn.ollyice.library.v4.view.InputDeviceCompat;
import cn.ollyice.library.v4.view.MotionEventCompat;
import cn.ollyice.library.v4.view.NestedScrollingChild;
import cn.ollyice.library.v4.view.NestedScrollingChildHelper;
import cn.ollyice.library.v4.view.ScrollingView;
import cn.ollyice.library.v4.view.VelocityTrackerCompat;
import cn.ollyice.library.v4.view.ViewCompat;
import cn.ollyice.library.v4.view.accessibility.AccessibilityEventCompat;
import cn.ollyice.library.v4.view.accessibility.AccessibilityNodeInfoCompat;
import cn.ollyice.library.v4.view.accessibility.AccessibilityRecordCompat;
import cn.ollyice.library.v4.widget.EdgeEffectCompat;
import cn.ollyice.library.v4.widget.ScrollerCompat;
import cn.ollyice.library.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context,  AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            String layoutManagerName = null;
            int descendantFocusability = -1;
    ...
    void animateAppearance( ViewHolder itemHolder,
    ...
    void animateDisappearance( ViewHolder holder,
             ItemHolderInfo preLayoutInfo,  ItemHolderInfo postLayoutInfo) {
    ...
    public static abstract class LayoutManager {
         ...
         */
        public boolean isViewPartiallyVisible( View child, boolean completelyVisible,
    ...
    public static abstract class ItemAnimator {
        ...
        public  ItemHolderInfo recordPreLayoutInformation( State state,
                 ViewHolder viewHolder, @AdapterChanges int changeFlags,
         ...
         * @see #animatePersistence(ViewHolder, ItemHolderInfo, ItemHolderInfo)
         */
        public  ItemHolderInfo recordPostLayoutInformation( State state,
